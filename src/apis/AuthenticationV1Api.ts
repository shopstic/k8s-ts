...
export class AuthenticationV1ApiRequestFactory extends BaseAPIRequestFactory {
  /**
     ...
     */
  public async createAuthenticationV1TokenReview(
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling createAuthenticationV1TokenReview.",
      );
    }
  ...
  /**
     ...
     */
  public async getAuthenticationV1APIResources(
    options?: Configuration,
  ): Promise<RequestContext> {
    let config = options || this.configuration;
...
export class AuthenticationV1ApiResponseProcessor {
  ...
  public async createAuthenticationV1TokenReview(
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sApiAuthenticationV1TokenReview = ObjectSerializer
        .deserialize(
