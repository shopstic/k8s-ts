...
export class NodeV1ApiRequestFactory extends BaseAPIRequestFactory {
  /**
     ...
     */
  public async createNodeV1RuntimeClass(
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling createNodeV1RuntimeClass.",
      );
    }
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "IoK8sApiNodeV1RuntimeClass", ""),
      contentType,
    );
  ...
  /**
     ...
     * @param body 
     */
  public async deleteNodeV1CollectionRuntimeClass(
    pretty?: string,
    _continue?: string,
    dryRun?: string,
  ...
  /**
     ...
     * @param body 
     */
  public async deleteNodeV1RuntimeClass(
    name: string,
    pretty?: string,
    dryRun?: string,
    gracePeriodSeconds?: number,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling deleteNodeV1RuntimeClass.",
      );
    }
  ...
  /**
     ...
     */
  public async getNodeV1APIResources(
    options?: Configuration,
  ): Promise<RequestContext> {
    let config = options || this.configuration;
  ...
  /**
     ...
     */
  public async listNodeV1RuntimeClass(
    pretty?: string,
  ...
  /**
     ...
     */
  public async patchNodeV1RuntimeClass(
    name: string,
    body: any,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling patchNodeV1RuntimeClass.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling patchNodeV1RuntimeClass.",
      );
    }
  ...
  /**
     ...
     * @param pretty If &#39;true&#39;, then the output is pretty printed.
     */
  public async readNodeV1RuntimeClass(
    name: string,
    pretty?: string,
    options?: Configuration,
  ): Promise<RequestContext> {
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling readNodeV1RuntimeClass.",
      );
    }
  ...
  /**
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
  public async replaceNodeV1RuntimeClass(
    name: string,
    body: IoK8sApiNodeV1RuntimeClass,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling replaceNodeV1RuntimeClass.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling replaceNodeV1RuntimeClass.",
      );
    }
  ...
  /**
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
  public async watchNodeV1RuntimeClass(
    name: string,
    allowWatchBookmarks?: boolean,
    _continue?: string,
    fieldSelector?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling watchNodeV1RuntimeClass.",
      );
    }

    // Path Params
    const localVarPath = "/apis/node.k8s.io/v1/watch/runtimeclasses/{name}"
      .replace("{" + "name" + "}", encodeURIComponent(String(name)));
  ...
  /**
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
  public async watchNodeV1RuntimeClassList(
    allowWatchBookmarks?: boolean,
    _continue?: string,
    fieldSelector?: string,
    labelSelector?: string,
    ...
    // Path Params
    const localVarPath = "/apis/node.k8s.io/v1/watch/runtimeclasses";
...
export class NodeV1ApiResponseProcessor {
  /**
     ...
     *
     * @params response Response returned by the server for a request to createNodeV1RuntimeClass
  ...
  public async createNodeV1RuntimeClass(
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sApiNodeV1RuntimeClass = ObjectSerializer.deserialize(
  ...
  /**
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteNodeV1CollectionRuntimeClass
     * @throws ApiException if the response code was not in [200, 299]
     */
  public async deleteNodeV1CollectionRuntimeClass(
    response: ResponseContext,
  ...
  /**
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteNodeV1RuntimeClass
     * @throws ApiException if the response code was not in [200, 299]
     */
  public async deleteNodeV1RuntimeClass(
    response: ResponseContext,
  ...
  /**
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getNodeV1APIResources
     * @throws ApiException if the response code was not in [200, 299]
     */
  public async getNodeV1APIResources(
    response: ResponseContext,
  ...
  /**
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to listNodeV1RuntimeClass
     * @throws ApiException if the response code was not in [200, 299]
     */
  public async listNodeV1RuntimeClass(
    response: ResponseContext,
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sApiNodeV1RuntimeClassList = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
  ...
  /**
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchNodeV1RuntimeClass
     * @throws ApiException if the response code was not in [200, 299]
     */
  public async patchNodeV1RuntimeClass(
    response: ResponseContext,
  ...
  /**
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to readNodeV1RuntimeClass
     * @throws ApiException if the response code was not in [200, 299]
     */
  public async readNodeV1RuntimeClass(
    response: ResponseContext,
  ...
  /**
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to replaceNodeV1RuntimeClass
     * @throws ApiException if the response code was not in [200, 299]
     */
  public async replaceNodeV1RuntimeClass(
    response: ResponseContext,
  ...
  /**
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to watchNodeV1RuntimeClass
     * @throws ApiException if the response code was not in [200, 299]
     */
  public async watchNodeV1RuntimeClass(
    response: ResponseContext,
  ...
  /**
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to watchNodeV1RuntimeClassList
     * @throws ApiException if the response code was not in [200, 299]
     */
  public async watchNodeV1RuntimeClassList(
    response: ResponseContext,
