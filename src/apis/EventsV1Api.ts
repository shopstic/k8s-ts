...
export class EventsV1ApiRequestFactory extends BaseAPIRequestFactory {
  /**
     ...
     */
  public async createEventsV1NamespacedEvent(
    namespace: string,
    ...
    if (namespace === null || namespace === undefined) {
      throw new RequiredError(
        "Required parameter namespace was null or undefined when calling createEventsV1NamespacedEvent.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling createEventsV1NamespacedEvent.",
      );
    }
  ...
  /**
     ...
     * @param body 
     */
  public async deleteEventsV1CollectionNamespacedEvent(
    namespace: string,
    pretty?: string,
    _continue?: string,
    dryRun?: string,
    ...
    if (namespace === null || namespace === undefined) {
      throw new RequiredError(
        "Required parameter namespace was null or undefined when calling deleteEventsV1CollectionNamespacedEvent.",
      );
    }
  ...
  /**
     ...
     * @param body 
     */
  public async deleteEventsV1NamespacedEvent(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling deleteEventsV1NamespacedEvent.",
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new RequiredError(
        "Required parameter namespace was null or undefined when calling deleteEventsV1NamespacedEvent.",
      );
    }
  ...
  /**
     ...
     */
  public async getEventsV1APIResources(
    options?: Configuration,
  ): Promise<RequestContext> {
    let config = options || this.configuration;
  ...
  /**
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
  public async listEventsV1NamespacedEvent(
    namespace: string,
    pretty?: string,
    allowWatchBookmarks?: boolean,
    _continue?: string,
    ...
    if (namespace === null || namespace === undefined) {
      throw new RequiredError(
        "Required parameter namespace was null or undefined when calling listEventsV1NamespacedEvent.",
      );
    }
  ...
  /**
     ...
     */
  public async patchEventsV1NamespacedEvent(
    name: string,
    namespace: string,
    body: any,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling patchEventsV1NamespacedEvent.",
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new RequiredError(
        "Required parameter namespace was null or undefined when calling patchEventsV1NamespacedEvent.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling patchEventsV1NamespacedEvent.",
      );
    }
  ...
  /**
     ...
     * @param pretty If &#39;true&#39;, then the output is pretty printed.
     */
  public async readEventsV1NamespacedEvent(
    name: string,
    namespace: string,
    pretty?: string,
    options?: Configuration,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling readEventsV1NamespacedEvent.",
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new RequiredError(
        "Required parameter namespace was null or undefined when calling readEventsV1NamespacedEvent.",
      );
    }
  ...
  /**
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
  public async replaceEventsV1NamespacedEvent(
    name: string,
    namespace: string,
    body: IoK8sApiEventsV1Event,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling replaceEventsV1NamespacedEvent.",
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new RequiredError(
        "Required parameter namespace was null or undefined when calling replaceEventsV1NamespacedEvent.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling replaceEventsV1NamespacedEvent.",
      );
    }
  ...
  /**
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
  public async watchEventsV1EventListForAllNamespaces(
    allowWatchBookmarks?: boolean,
    _continue?: string,
    fieldSelector?: string,
    labelSelector?: string,
  ...
  /**
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
  public async watchEventsV1NamespacedEvent(
    name: string,
    namespace: string,
    allowWatchBookmarks?: boolean,
    _continue?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling watchEventsV1NamespacedEvent.",
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new RequiredError(
        "Required parameter namespace was null or undefined when calling watchEventsV1NamespacedEvent.",
      );
    }
  ...
  /**
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
  public async watchEventsV1NamespacedEventList(
    namespace: string,
    allowWatchBookmarks?: boolean,
    _continue?: string,
    fieldSelector?: string,
    ...
    if (namespace === null || namespace === undefined) {
      throw new RequiredError(
        "Required parameter namespace was null or undefined when calling watchEventsV1NamespacedEventList.",
      );
    }
