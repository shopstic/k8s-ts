 ...
 * no description
 */
export class AuthenticationV1beta1ApiRequestFactory
  ...
  /**
     ...
     */
  public async createAuthenticationV1beta1TokenReview(
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling createAuthenticationV1beta1TokenReview.",
      );
    }
  ...
  /**
     ...
     */
  public async getAuthenticationV1beta1APIResources(
    options?: Configuration,
  ): Promise<RequestContext> {
    let config = options || this.configuration;
...
export class AuthenticationV1beta1ApiResponseProcessor {
  ...
  public async createAuthenticationV1beta1TokenReview(
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sApiAuthenticationV1beta1TokenReview = ObjectSerializer
        .deserialize(
