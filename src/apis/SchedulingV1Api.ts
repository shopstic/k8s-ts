...
export class SchedulingV1ApiRequestFactory extends BaseAPIRequestFactory {
  /**
     ...
     */
  public async createSchedulingV1PriorityClass(
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling createSchedulingV1PriorityClass.",
      );
    }
  ...
  /**
     ...
     * @param body 
     */
  public async deleteSchedulingV1CollectionPriorityClass(
    pretty?: string,
    _continue?: string,
    dryRun?: string,
  ...
  /**
     ...
     * @param body 
     */
  public async deleteSchedulingV1PriorityClass(
    name: string,
    pretty?: string,
    dryRun?: string,
    gracePeriodSeconds?: number,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling deleteSchedulingV1PriorityClass.",
      );
    }
  ...
  /**
     ...
     */
  public async getSchedulingV1APIResources(
    options?: Configuration,
  ): Promise<RequestContext> {
    let config = options || this.configuration;
  ...
  /**
     ...
     */
  public async listSchedulingV1PriorityClass(
    pretty?: string,
  ...
  /**
     ...
     */
  public async patchSchedulingV1PriorityClass(
    name: string,
    body: any,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling patchSchedulingV1PriorityClass.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling patchSchedulingV1PriorityClass.",
      );
    }
  ...
  /**
     ...
     * @param pretty If &#39;true&#39;, then the output is pretty printed.
     */
  public async readSchedulingV1PriorityClass(
    name: string,
    pretty?: string,
    options?: Configuration,
  ): Promise<RequestContext> {
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling readSchedulingV1PriorityClass.",
      );
    }
  ...
  /**
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
  public async replaceSchedulingV1PriorityClass(
    name: string,
    body: IoK8sApiSchedulingV1PriorityClass,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling replaceSchedulingV1PriorityClass.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling replaceSchedulingV1PriorityClass.",
      );
    }
  ...
  /**
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
  public async watchSchedulingV1PriorityClass(
    name: string,
    allowWatchBookmarks?: boolean,
    _continue?: string,
    fieldSelector?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling watchSchedulingV1PriorityClass.",
      );
    }
  ...
  /**
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
  public async watchSchedulingV1PriorityClassList(
    allowWatchBookmarks?: boolean,
    _continue?: string,
    fieldSelector?: string,
    labelSelector?: string,
...
export class SchedulingV1ApiResponseProcessor {
  ...
  public async createSchedulingV1PriorityClass(
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sApiSchedulingV1PriorityClass = ObjectSerializer
        .deserialize(
  ...
  public async listSchedulingV1PriorityClass(
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sApiSchedulingV1PriorityClassList = ObjectSerializer
        .deserialize(
          ObjectSerializer.parse(await response.body.text(), contentType),
