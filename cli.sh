...
gen_types() {
  local SPEC_URL=${1:-"https://raw.githubusercontent.com/kubernetes/kubernetes/v1.23.10/api/openapi-spec/swagger.json"}
  ...
  openapi-ts <(curl -sf "${SPEC_URL}") "$THIS_DIR"/scripts/openapi-ts-formatter.mjs >> "$THIS_DIR"/src/openapi.ts
