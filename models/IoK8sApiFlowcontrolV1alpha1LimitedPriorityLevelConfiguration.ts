...
*/
export class IoK8sApiFlowcontrolV1alpha1LimitedPriorityLevelConfiguration {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return IoK8sApiFlowcontrolV1alpha1LimitedPriorityLevelConfiguration.attributeTypeMap;
    }
