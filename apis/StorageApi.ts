...
export class StorageApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getStorageAPIGroup(options?: Configuration): Promise<RequestContext> {
...
export class StorageApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getStorageAPIGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getStorageAPIGroup(response: ResponseContext): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup > {
