...
export class AuthorizationApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAuthorizationAPIGroup(options?: Configuration): Promise<RequestContext> {
...
export class AuthorizationApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getAuthorizationAPIGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getAuthorizationAPIGroup(response: ResponseContext): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup > {
