...
export class AuthorizationV1ApiRequestFactory extends BaseAPIRequestFactory {
  /**
     ...
     */
  public async createAuthorizationV1NamespacedLocalSubjectAccessReview(
    namespace: string,
    ...
    if (namespace === null || namespace === undefined) {
      throw new RequiredError(
        "Required parameter namespace was null or undefined when calling createAuthorizationV1NamespacedLocalSubjectAccessReview.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling createAuthorizationV1NamespacedLocalSubjectAccessReview.",
      );
    }
  ...
  /**
     ...
     * @param pretty If &#39;true&#39;, then the output is pretty printed.
     */
  public async createAuthorizationV1SelfSubjectAccessReview(
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling createAuthorizationV1SelfSubjectAccessReview.",
      );
    }
  ...
  /**
     ...
     * @param pretty If &#39;true&#39;, then the output is pretty printed.
     */
  public async createAuthorizationV1SelfSubjectRulesReview(
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling createAuthorizationV1SelfSubjectRulesReview.",
      );
    }
  ...
  /**
     ...
     * @param pretty If &#39;true&#39;, then the output is pretty printed.
     */
  public async createAuthorizationV1SubjectAccessReview(
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling createAuthorizationV1SubjectAccessReview.",
      );
    }
  ...
  /**
     ...
     */
  public async getAuthorizationV1APIResources(
    options?: Configuration,
  ): Promise<RequestContext> {
    let config = options || this.configuration;
...
export class AuthorizationV1ApiResponseProcessor {
  ...
  public async createAuthorizationV1NamespacedLocalSubjectAccessReview(
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sApiAuthorizationV1LocalSubjectAccessReview =
  ...
  public async createAuthorizationV1SelfSubjectAccessReview(
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sApiAuthorizationV1SelfSubjectAccessReview =
        ObjectSerializer.deserialize(
          ObjectSerializer.parse(await response.body.text(), contentType),
          "IoK8sApiAuthorizationV1SelfSubjectAccessReview",
          "",
  ...
  public async createAuthorizationV1SelfSubjectRulesReview(
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sApiAuthorizationV1SelfSubjectRulesReview =
        ObjectSerializer.deserialize(
          ObjectSerializer.parse(await response.body.text(), contentType),
          "IoK8sApiAuthorizationV1SelfSubjectRulesReview",
          "",
  ...
  public async createAuthorizationV1SubjectAccessReview(
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sApiAuthorizationV1SubjectAccessReview = ObjectSerializer
        .deserialize(
          ObjectSerializer.parse(await response.body.text(), contentType),
          "IoK8sApiAuthorizationV1SubjectAccessReview",
          "",
