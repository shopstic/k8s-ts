...
export class NodeApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getNodeAPIGroup(options?: Configuration): Promise<RequestContext> {
...
export class NodeApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getNodeAPIGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getNodeAPIGroup(response: ResponseContext): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup > {
