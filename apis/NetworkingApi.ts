...
export class NetworkingApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getNetworkingAPIGroup(options?: Configuration): Promise<RequestContext> {
...
export class NetworkingApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getNetworkingAPIGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getNetworkingAPIGroup(response: ResponseContext): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup > {
