...
export class AppsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAppsAPIGroup(options?: Configuration): Promise<RequestContext> {
...
export class AppsApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getAppsAPIGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getAppsAPIGroup(response: ResponseContext): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup > {
