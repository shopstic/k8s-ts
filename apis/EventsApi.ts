...
export class EventsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getEventsAPIGroup(options?: Configuration): Promise<RequestContext> {
...
export class EventsApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getEventsAPIGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getEventsAPIGroup(response: ResponseContext): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup > {
