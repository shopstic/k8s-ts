...
export class CertificatesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getCertificatesAPIGroup(options?: Configuration): Promise<RequestContext> {
...
export class CertificatesApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getCertificatesAPIGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getCertificatesAPIGroup(response: ResponseContext): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup > {
