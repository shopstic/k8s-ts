...
export class PolicyApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getPolicyAPIGroup(options?: Configuration): Promise<RequestContext> {
...
export class PolicyApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getPolicyAPIGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getPolicyAPIGroup(response: ResponseContext): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup > {
