...
export class AuthenticationApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAuthenticationAPIGroup(options?: Configuration): Promise<RequestContext> {
...
export class AuthenticationApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getAuthenticationAPIGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getAuthenticationAPIGroup(response: ResponseContext): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup > {
