 ...
 * no description
 */
export class ApiregistrationV1beta1ApiRequestFactory
  ...
  /**
     ...
     */
  public async createApiregistrationV1beta1APIService(
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling createApiregistrationV1beta1APIService.",
      );
    }
  ...
  /**
     ...
     * @param body 
     */
  public async deleteApiregistrationV1beta1APIService(
    name: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling deleteApiregistrationV1beta1APIService.",
      );
    }
  ...
  /**
     ...
     */
  public async getApiregistrationV1beta1APIResources(
    options?: Configuration,
  ): Promise<RequestContext> {
    let config = options || this.configuration;
  ...
  /**
     ...
     */
  public async listApiregistrationV1beta1APIService(
    pretty?: string,
  ...
  /**
     ...
     */
  public async patchApiregistrationV1beta1APIService(
    name: string,
    body: any,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling patchApiregistrationV1beta1APIService.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling patchApiregistrationV1beta1APIService.",
      );
    }
  ...
  /**
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
  public async patchApiregistrationV1beta1APIServiceStatus(
    name: string,
    body: any,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling patchApiregistrationV1beta1APIServiceStatus.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling patchApiregistrationV1beta1APIServiceStatus.",
      );
    }
  ...
  /**
     ...
     */
  public async readApiregistrationV1beta1APIService(
    name: string,
    pretty?: string,
    exact?: boolean,
    _export?: boolean,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling readApiregistrationV1beta1APIService.",
      );
    }
  ...
  /**
     ...
     * @param pretty If &#39;true&#39;, then the output is pretty printed.
     */
  public async readApiregistrationV1beta1APIServiceStatus(
    name: string,
    pretty?: string,
    options?: Configuration,
  ): Promise<RequestContext> {
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling readApiregistrationV1beta1APIServiceStatus.",
      );
    }
  ...
  /**
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
  public async replaceApiregistrationV1beta1APIService(
    name: string,
    body: IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling replaceApiregistrationV1beta1APIService.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling replaceApiregistrationV1beta1APIService.",
      );
    }
  ...
  /**
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
  public async replaceApiregistrationV1beta1APIServiceStatus(
    name: string,
    body: IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling replaceApiregistrationV1beta1APIServiceStatus.",
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new RequiredError(
        "Required parameter body was null or undefined when calling replaceApiregistrationV1beta1APIServiceStatus.",
      );
    }
  ...
  public async watchApiregistrationV1beta1APIService(
    ...
    if (name === null || name === undefined) {
      throw new RequiredError(
        "Required parameter name was null or undefined when calling watchApiregistrationV1beta1APIService.",
      );
    }
  ...
  /**
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
  public async watchApiregistrationV1beta1APIServiceList(
    allowWatchBookmarks?: boolean,
    _continue?: string,
    fieldSelector?: string,
    labelSelector?: string,
...
export class ApiregistrationV1beta1ApiResponseProcessor {
  ...
  public async createApiregistrationV1beta1APIService(
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService =
